  ...
  return (
    <div className="card bg-base-100 shadow-sm">
      <div className="card-body">
        ...
        <div className="bg-[#F3F3F3] flex justify-between items-center p-5">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <h2 className="text-xs text-[#706F6F]">{news.author?.published_date}</h2>
                </div>
            </div>
        ...
        <p className="text-[#706F6F] p-2 line-clamp-3">{news.details}</p>

        <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
                <h2 className="flex items-center gap-1"><CiStar />{news.rating.number}</h2>
